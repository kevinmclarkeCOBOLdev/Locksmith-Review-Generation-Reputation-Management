...
async function runSchemaMigrationTests() {
  ...
  assert(renderedSms.includes('DEMO Locksmith'), 'Rendered SMS contains business name');
  ...
  assert(renderedEmail.includes('DEMO Locksmith'), 'Rendered Email contains business name');
